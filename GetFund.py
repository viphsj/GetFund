...
class FundSpiders():  
    ...
    def getFundGZ(self,fund_code):
        ...
        fund_gz_str = fund_gz["name"] + " 估值：" + fund_gz["gsz"] + " 涨幅：" + fund_gz["gszzl"] + "% ( " + fund_gszzl +" ) " + fund_gz["gztime"]
        # print (fund_gz_str)
        rss = PyRSS2Gen.RSSItem(
            title = fund_gz_str,
            link = "https://m.1234567.com.cn/index.html?page=jjxq&code=" + fund_code,
            description = "代码：" + fund_code + "\n" + "估值：" + fund_gz["gsz"] + "\n" + "涨幅：" + fund_gz["gszzl"] + "% ( " + fund_gszzl + " ) " + "\n" + "更新时间：" + fund_gz["gztime"],
            pubDate = getRfc822Time()
            )
